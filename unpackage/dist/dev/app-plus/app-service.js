...
This will fail in production if not fixed.`);
    ...
    setup(__props) {
      ...
      function initBlue() {
        uni.openBluetoothAdapter({
          success(res) {
            formatAppLog("log", "at pages/index/index.vue:60", "初始化蓝牙成功");
            formatAppLog("log", "at pages/index/index.vue:61", res);
          },
          fail(err) {
            formatAppLog("log", "at pages/index/index.vue:64", "初始化蓝牙失败");
      ...
      function discovery() {
        uni.startBluetoothDevicesDiscovery({
          success(res) {
            formatAppLog("log", "at pages/index/index.vue:74", "开始搜索");
            uni.onBluetoothDeviceFound(found);
          },
          fail(err) {
            formatAppLog("log", "at pages/index/index.vue:79", "搜索失败");
      ...
      function connect(data) {
        ...
        uni.createBLEConnection({
          ...
          success(res) {
            formatAppLog("log", "at pages/index/index.vue:115", "连接成功");
          ...
          fail(err) {
            formatAppLog("log", "at pages/index/index.vue:124", "连接失败");
      ...
      function stopDiscovery() {
        uni.stopBluetoothDevicesDiscovery({
          success(res) {
            formatAppLog("log", "at pages/index/index.vue:138", "停止成功");
            formatAppLog("log", "at pages/index/index.vue:139", res);
          },
          fail(err) {
            formatAppLog("log", "at pages/index/index.vue:142", "停止失败");
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", null, [
          ...
          vue.createElementVNode("navigator", {
            ...
            vue.createElementVNode("button", { type: "default" }, "跳转操作页面")
          ])
        ]);
      };
    }
  };
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "E:/RC挖掘机/bluetooth/pages/index/index.vue"]]);
  const _sfc_main$1 = {
    __name: "operate",
    setup(__props) {
      const bluetoothInfo = useBluetoothInfoStore();
      ...
      const longpress = (index, val) => {
        formatAppLog("log", "at pages/operate/operate.vue:20", "长按");
      ...
      const sliderChange = (e) => {
        formatAppLog("log", "at pages/operate/operate.vue:88", "value 发生变化：" + e.detail.value);
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "operate" }, [
          vue.createElementVNode("view", { class: "front" }, [
            vue.createElementVNode("ul", null, [
              ...
              vue.createElementVNode("li", null, [
                vue.createElementVNode("div", { class: "title" }, "速度"),
              ...
              vue.createElementVNode("li", null, [
                vue.createElementVNode("div", { class: "title" }, "喇叭"),
          ...
          vue.createElementVNode("view", { class: "direction" }, [
            vue.createElementVNode("ul", null, [
              vue.createElementVNode("li", null, [
                vue.createElementVNode("div", { class: "title" }, "前后"),
              ...
              vue.createElementVNode("li", null, [
                vue.createElementVNode("div", { class: "title" }, "旋转"),
              ...
              vue.createElementVNode("li", null, [
                vue.createElementVNode("div", { class: "title" }, "左右"),
                vue.createElementVNode("div", { class: "lr btn" }, [
                  vue.createElementVNode(
                    "button",
                    {
  ...
  const PagesOperateOperate = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "E:/RC挖掘机/bluetooth/pages/operate/operate.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/RC挖掘机/bluetooth/App.vue"]]);
  function createApp() {
